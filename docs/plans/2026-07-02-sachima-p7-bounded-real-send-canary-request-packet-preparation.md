...
| delivery_url_class | `p7_delivery_url_class_canary` — a **class label**, never a URL/secret | the operator confirms the class; the concrete endpoint lives only in the future adapter/config, never in this packet, state, log, or evidence. |
