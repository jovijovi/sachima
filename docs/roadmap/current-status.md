...
> PR #138 merged WP3a cancellation request-state + supervisor interrupt API. This row records the phase PR merge commit; the follow-up status-cleanup PR, if any, is housekeeping only and does not change WP3a scope.
