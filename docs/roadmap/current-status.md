...
| Live stream workbench/query integration | Planned / requires approval | The docs-only live-stream integration plan is the current next-step authority. PR-LS1, PR-LS2, PR-LS3, and PR-LS4 each require separate named approval, gates, review, CI, and merge guard. |
