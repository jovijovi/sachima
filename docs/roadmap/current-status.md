...
The next safe mainline request, if desired, is a **new docs-only design gate** for the next supervisor → Sachima capability. Do not skip straight to live/runtime expansion.
