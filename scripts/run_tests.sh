...
# gateway .env and affect collection-time imports before pytest fixtures run.
unset API_SERVER_ENABLED API_SERVER_HOST API_SERVER_PORT \
      ...
      GOOGLE_CHAT_HOME_CHANNEL GOOGLE_CHAT_HOME_CHANNEL_NAME \
      GOOGLE_CHAT_ALLOWED_USERS GOOGLE_CHAT_ALLOW_ALL_USERS 2>/dev/null || true
