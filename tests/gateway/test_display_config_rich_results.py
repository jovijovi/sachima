...
def test_rich_result_weather_defaults_off_until_explicitly_enabled():
    assert resolve_display_setting({}, "telegram", "rich_result_weather") == "off"
    assert resolve_display_setting({}, "feishu", "rich_result_weather") == "off"
...
def test_rich_result_weather_normalises_bool_and_unknown_modes():
    ...
    assert resolve_display_setting({"display": {"rich_result_weather": "weird"}}, "feishu", "rich_result_weather") == "off"
