...
CONFIGURABLE_TOOLSETS = [
    ...
    ("memory_palace",   "🏰 Memory Palace",             "profile-scoped markdown palace notes"),
    ("clock",           "🕒 Clock",                     "current time/date lookup"),
    ("calendar",        "📅 Calendar & Holidays",       "China lunar + common Western holidays"),
    ("weather",         "🌦️ Weather",                   "narrow weather lookup + rich cards"),
    ("journal",         "📓 Journal",                   "append diary notes to profile palace"),
    ("context_engine",  "🧩 Context Engine",            "runtime tools from the active context engine"),
    ("session_search",  "🔎 Session Search",            "search past conversations"),
    ("clarify",         "❓ Clarifying Questions",      "clarify"),
    ("delegation",      "👥 Task Delegation",           "delegate_task"),
    ("cronjob",         "⏰ Cron Jobs",                 "create/list/update/pause/resume/run, with optional attached skills"),
    ("messaging",       "💬 Cross-platform Messaging",  "send_message, GitHub PR approval cards"),
